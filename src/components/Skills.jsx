      ...
      <div className="w-full max-w-md sm:max-w-lg lg:max-w-2xl mx-auto">
        <BlurFade delay={0.25}>
          <div className="flex justify-center gap-3">
            {/* <FaCode size={44} /> */}
            <Title title="My skill set" className="lg:mr-12" />
          </div>
        </BlurFade>
        <BlurFade delay={0.25 * 5}>
          <div className="flex flex-col gap-4">
            ...
            <progress
              className="progress progress-info w-full lg:w-96"
              value="90"
              max="100"
            ></progress>
            <span className="text-lg flex">
            ...
            <progress
              className="progress progress-accent w-full lg:w-96"
              value="80"
              max="100"
            ></progress>
            <span className="text-lg flex">
            ...
            <progress
              className="progress progress-warning w-full lg:w-96"
              value="70"
              max="100"
            ></progress>
            <span className="text-lg flex">
            ...
            <progress
              className="progress progress-primary w-full lg:w-96"
              value="60"
              max="100"
            ></progress>
            <span className="text-lg flex">
            ...
            <progress
              className="progress progress-error w-full lg:w-96"
              value="70"
              max="100"
            ></progress>
            <span className="text-lg flex">
            ...
            <progress className="progress w-full lg:w-96" value="50" max="100"></progress>
            <span className="text-lg flex">
              <SiDotnet size={30} className="mr-2" />
              C#
            </span>
            <progress className="progress progress-success w-full lg:w-96" value="50" max="100"></progress>
          </div>
        </BlurFade>
      </div>
    </>
